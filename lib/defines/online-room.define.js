...
exports.createMockOnlinerooms = exports.createMockOnlineroom = exports.onlineRoomLogger = void 0;
...
const createMockOnlineroom = (roomStatusInterval) => {
    return new Onlineroom(faker_1.faker.string.uuid(), roomStatusInterval);
};
exports.createMockOnlineroom = createMockOnlineroom;
const createMockOnlinerooms = (length, roomStatusInterval) => {
    return Array.from({ length }).map(() => (0, exports.createMockOnlineroom)(roomStatusInterval));
};
exports.createMockOnlinerooms = createMockOnlinerooms;
